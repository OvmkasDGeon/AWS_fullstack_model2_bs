				...
				<div class="card-body">
					...
					<div class="mb-3 mt-3 form-group">
						<div class="d-flex justify-content-between">
							<h4 class="d-inline-block">${member.id}</h4>
								<a href="#" class="btn btn-success btn-sm ms-3">비밀번호 변경</a>
						</div>
					...
					<div class="mb-3 form-group border-bottom">
							<label for="name" class="form-label">Name</label> <input type="text" class="form-control border-0 border-bottom"" id="name" placeholder="Enter your name" name="name" value="${member.name}">
						</div>
						<div class="mb-3 form-group">
							<label for="email" class="form-label">Email</label> <input type="text" class="form-control border-0 border-bottom"" id="email" placeholder="Enter your email" name="email" value="${member.email}">
						</div>
						<div class="mb-3">
							<label for="addr" class="form-label">Address</label>
							 <div class="input-group form-group">
								 <input type="text" class="form-control border-0 border-bottom" id="addr" placeholder="" name="addr" readonly value="${member.addr}">
								 <button class="btn btn-primary" type="button" id="btnAddr">주소검색</button>
							 </div>
							 <div class="form-group">
							 <input type="text" class="form-control border-0 border-bottom mt-2" id="addrDetail" placeholder="상세주소" name="addrDetail" value="${member.addrDetail}">
							 </div>
						</div>
						<div class="mb-3">
