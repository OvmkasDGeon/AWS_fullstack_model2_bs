							...
							<div class="row card-body p-0">
								<ul class="chatonline">
									<c:forEach items="${list.value}" var="board">
										<li class="py-2"><a href="${pageContext.request.contextPath}/board/view?bno=${board.bno}" class="text-dark">${board.title}</a>
											<span class="text-danger">[${board.replyCnt}]</span></li>
									</c:forEach>
									<c:if test="${empty list.value}">
									<li class="py-2"><a href="/board/view?bno=${board.bno}" class="text-dark">작성된 게시글이 없습니다</a></li>
									</c:if>
								</ul>
							</div>
						</div>
